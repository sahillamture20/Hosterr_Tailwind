const Body = () => {
  return (
    <div className="lg:flex md:space-y-20">
      <div className="flex items-center justify-center lg:flex-1 lg:order-2 lg:justify-end lg:overflow-hidden">
        <img
          ...
          alt="img1"
          className="h-64 -rotate-45 md:h-72 lg:h-[400px] lg:overflow-hidden"
        />
        <img
          src="./assets/Pink-Shape.svg"
          alt="img2"
          className="absolute h-64 -rotate-[30deg]  md:h-72 lg:h-[400px] lg:overflow-hidden"
        />
        <img
          src="./assets/Purple-Shape.svg"
          alt="img3"
          className="absolute h-64 -rotate-[15deg]  md:h-72 lg:h-[400px] lg:overflow-hidden"
        />
        <img
          src="./assets/Hero-Model.png"
          alt="hero"
          className="absolute h-64  md:h-72 lg:h-[400px] lg:overflow-hidden"
        />
      </div>
      <div className="space-y-4 lg:flex-1 lg:order-1 lg:space-y-10">
        ...
        <div className="flex gap-2">
          ...
          <p className="font-lato text-green-400">
